        ...
        return(
            ...
            <Router>
                <Container>
                    ...
                    {
                        this.props.message.active ? ReactDOM.createPortal(<Message /> , document.getElementById("modal")) : null
                    }

                    {
                        this.props.modal.active ? ReactDOM.createPortal(<Modal /> , document.getElementById("modal")) : null
                    }
                </Container>
            </Router>
        )
